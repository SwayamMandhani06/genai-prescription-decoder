...
export const SAMPLE_PRESCRIPTION_CANVASES: Record<string, PrescriptionSvgCanvasData> = {
  'rx-sample-1': {
    ...
    clinicStampText: 'DEMO PRACTICE · FOR EVALUATION ONLY',
    doctorSignaturePath:
  ...
  'rx-sample-2': {
    ...
    doctorHeader: {
      name: 'Example Prescriber, M.D. (Endocrinology)',
      qualifications: 'Consulting Specialist (Illustrative Demo)',
      regNo: 'Demo Reg. No. 00000',
      clinicName: 'EXAMPLE SPECIALTY CLINIC',
      clinicAddress: 'Sample Clinic Address (Evaluation Demo)',
      phone: 'Demo Document Only',
    },
    patientInfo: {
      ...
      ageGender: 'Adult / Demo',
      date: 'DD-MM-YYYY (Example)',
      vitals: 'Clinical Indicators: Example Values',
      weight: '65 kg (Demo)',
    },
    rxSymbolPath:
      'M 24 135 C 28 105, 46 95, 62 102 C 78 108, 76 130, 58 138 C 42 144, 30 155, 26 178 M 46 142 L 72 178 M 40 156 L 68 152',
    paperType: 'hospital_stationery',
    clinicStampText: 'EXAMPLE SPECIALTY CLINIC · DEMO RECORD',
    doctorSignaturePath:
  ...
  'rx-sample-3': {
    ...
    doctorHeader: {
      ...
      qualifications: 'Paediatric Specialist (Illustrative Demo)',
      regNo: 'Demo Reg. No. 00000',
      clinicName: 'EXAMPLE PAEDIATRIC CLINIC',
      clinicAddress: 'Sample Clinic Address (Evaluation Demo)',
      phone: 'Demo Document Only',
    },
    patientInfo: {
      name: 'Demo Patient (Paediatric)',
      ageGender: 'Child / Demo',
      date: 'DD-MM-YYYY (Example)',
      vitals: 'Clinical Indicators: Example Values',
      weight: '20 kg (Demo)',
    },
    rxSymbolPath:
      'M 24 135 C 28 105, 46 95, 62 102 C 78 108, 76 130, 58 138 C 42 144, 30 155, 26 178 M 46 142 L 72 178 M 40 156 L 68 152',
    paperType: 'hospital_stationery',
    clinicStampText: 'EXAMPLE PAEDIATRIC CLINIC · AMBIGUITY DEMO SCRIPT',
    doctorSignaturePath:
