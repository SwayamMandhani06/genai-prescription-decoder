...
export const MultilingualExplanationSection: React.FC = () => {
  ...
  return (
    <section id="multilingual" className="py-20 bg-[#080C16] border-t border-white/[0.08] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-10">
          <div className="inline-flex bg-slate-900/90 p-1.5 rounded-2xl border border-white/10 backdrop-blur-md">
            {[
              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-xl text-xs sm:text-sm font-medium transition-all cursor-pointer flex flex-col items-center gap-0.5 ${
                  selectedLanguage === item.code
                    ? 'bg-cyan-500 text-slate-950 font-bold shadow-[0_0_20px_rgba(14,165,233,0.4)]'
              ...
              >
                ...
                <span
                  className={`text-[10px] ${
                    selectedLanguage === item.code ? 'text-slate-900' : 'text-slate-500'
                  }`}
                >
                  {item.sub}
                </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8">
            <Card variant="glass" padding="lg" className="border-cyan-500/30">
              <div className="flex flex-wrap items-start justify-between gap-4 pb-4 border-b border-white/[0.08] mb-6">
                <div>
                ...
                <button
                  ...
                  className="px-3.5 py-2 rounded-xl bg-cyan-950/40 border border-cyan-500/30 hover:border-cyan-400 text-cyan-300 text-xs font-mono flex items-center gap-2 transition-all cursor-pointer"
                >
                  {isPlayingAudio ? (
              ...
              <div className="mb-6 p-4 rounded-xl bg-slate-950/60 border border-white/5 space-y-1">
                    ...
                    return (
                      <div
                        ...
                        className={`p-3.5 rounded-xl border transition-all flex flex-col justify-between min-h-[140px] ${
                          slot.isActive
                            ? 'bg-cyan-950/20 border-cyan-500/40 shadow-[0_0_15px_rgba(14,165,233,0.1)]'
                      ...
                      >
                        ...
                        <div>
                          <div
                            className={`text-base font-bold font-mono ${
                              slot.isActive ? 'text-white' : 'text-slate-500'
                            }`}
                          >
                            {slot.amount}
                          </div>
                        ...
                        <div className="mt-2 pt-2 border-t border-white/5 text-[10px] text-slate-400 line-clamp-2">
                          {slot.mealRelation}
                        </div>
                      </div>
                    );
              ...
              {/* Instructions Bar */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-mono pt-4 border-t border-white/[0.08]">
                <div className="p-3 rounded-lg bg-black/40 border border-white/5 space-y-1">
                  ...
                  <div className="text-slate-200">{primaryMed.foodInstruction}</div>
                </div>
                ...
                <div className="p-3 rounded-lg bg-black/40 border border-white/5 space-y-1">
                  ...
                  <div className="text-slate-200">{primaryMed.durationString}</div>
                </div>
              </div>
            </Card>
          </div>
          ...
          <div className="lg:col-span-4 space-y-4">
            <div className="p-5 rounded-xl bg-slate-900/60 border border-white/[0.08] space-y-3">
              ...
              {sampleData.medications.map((m) => (
                ...
                >
                  <div className="text-xs font-bold text-white">{m.localizedName}</div>
                  <div className="text-[11px] text-slate-400">{m.purpose}</div>
                  <div className="text-[10px] font-mono text-cyan-400">{m.dosageSummary}</div>
                </div>
              ))}
            </div>

            {/* Overall Advice Callout */}
            <div className="p-5 rounded-xl bg-cyan-950/20 border border-cyan-500/30 space-y-2 text-xs">
