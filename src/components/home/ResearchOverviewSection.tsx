      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="p-8 sm:p-12 rounded-3xl bg-surface border border-theme flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 shadow-xs">
          <div className="space-y-4 max-w-2xl">
            ...
            <div className="flex flex-wrap items-center gap-y-2 gap-x-6 text-xs text-theme-muted pt-1">
          ...
          <div className="shrink-0 w-full lg:w-auto">
            {onOpenResearchPage && (
              <button
                ...
                className="w-full sm:w-auto px-6 py-3.5 rounded-xl bg-surface-subtle hover:bg-surface border border-theme text-theme-primary text-sm font-semibold transition-all flex items-center justify-center gap-2.5 shadow-xs cursor-pointer group"
              >
