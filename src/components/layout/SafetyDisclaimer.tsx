...
export const SafetyDisclaimer: React.FC = () => {
  return (
    <section className="py-12 bg-[#080C16] border-y border-white/[0.08] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-amber-950/20 via-slate-900/40 to-cyan-950/20 border border-amber-500/25 rounded-2xl p-6 sm:p-8 backdrop-blur-md relative">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <h3 className="text-base sm:text-lg font-bold text-white">
                  Explainable Decision Support — Not an Autonomous Prescriber
                </h3>
            ...
            <div className="shrink-0 flex flex-col sm:flex-row lg:flex-col gap-2.5 w-full lg:w-auto">
              <div className="flex items-center gap-2 text-xs text-emerald-400 font-mono bg-slate-900/60 px-3 py-2 rounded-lg border border-emerald-500/20">
                <CheckCircle2 className="w-4 h-4 shrink-0" />
                <span>Zero Hallucination Tolerance</span>
              </div>
              <div className="flex items-center gap-2 text-xs text-cyan-400 font-mono bg-slate-900/60 px-3 py-2 rounded-lg border border-cyan-500/20">
